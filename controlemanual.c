...
int main(int argc, char *argv[])
{
	...
	do{
		...
		pthread_create(&t1, NULL, (void *) controle_temperatura, NULL);
		pthread_create(&t2, NULL, (void *) controle_nivel_agua, NULL);
